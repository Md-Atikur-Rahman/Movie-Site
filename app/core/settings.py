...
DATABASES = {
    'default': {
        ...
        'NAME': 'railway',
        'USER': 'postgres',
        'PASSWORD': 'xndoZfHuoYnQrciQIlxpkTUXBznaujye',
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'md.atik.dev@gmail.com'  # Your email address
EMAIL_HOST_PASSWORD = 'aujv uecl uepz mvuc'  # Your email password
